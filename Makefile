...
# Generated by qmake (2.01a) (Qt 4.8.6) on: Di. Jun 24 17:17:09 2014
...
moc_mysocket.cpp: network/mysocket.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) network/mysocket.h -o moc_mysocket.cpp

moc_myserver.cpp: network/myserver.h
	/usr/lib/x86_64-linux-gnu/qt4/bin/moc $(DEFINES) $(INCPATH) network/myserver.h -o moc_myserver.cpp
